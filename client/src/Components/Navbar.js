...
const Navbar = () => {
    ...
    useEffect(()=>{
        ...
        setNavBtn([pathname==='/posts',pathname==='/shop',pathname==='/chat',pathname==='/profile'])
    },[location.pathname])
    ...
    return (
        <div id="navBar">
            {searching&&<Profiles search={searchValue}/>}
            <div id="navSearch">
                ...
                <form>
                    ...
                    <input type="text" placeholder="Search..." id="searchField" autoComplete='off' onClick={()=>setSearching(true)} onBlur={()=>{setTimeout(()=>setSearching(false),300)}} value={searchValue} onChange={e=>setSearchValue(e.target.value)}/>
                </form>
            </div>
            <div id="navSelect">
                <ul>
